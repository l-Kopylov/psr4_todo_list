...
function htmlShowList(res) {
    ...
    if (null === data) {
        ...
        data.forEach(function (element) {
            ...
            html += '<input type="checkbox" ' + ck + ' data-id="' + element.id + '"><span><span>' + element.task_name + '</span>' +
                '<input id="hide" name="task_name" value="' + element.task_name + '" data-id="' + element.id + '" data-name="' + element.task_name + '" type="hidden" ></span>' +
                '<span class="btn btn-sm" id="btn" data-id=' + element.id + '><i class="fa fa-trash"></i></span>'
            // html += ''
            html += '</li></form>';
            ck = ''
            complete = ''
